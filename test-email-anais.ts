...
// Configuration pour tester l'envoi d'email à anais.manne@gmail.com
async function testEmailAnais() {
  console.log('???? Test d\'envoi d\'email à anais.manne@gmail.com...\n');
  ...
  try {
    ...
    // Email de test
    const mailOptions = {
      from: `"Jay's Creations Design" <${process.env.IONOS_EMAIL_USER}>`,
