...
const BG_COLOR = { r: 250, g: 247, b: 242 }; // #FAF7F2
...
async function uniformizeImage(inputPath, outputPath) {
  try {
    ...
    // Create shadow (a blurred semi-transparent ellipse below product)
    const shadowSvg = `
