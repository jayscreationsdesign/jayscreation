...
export default function SubcategoryPage() {
  ...
  const subcategorySlug = params.sub as string;
  ...
  // Fetcher les produits de la sous-catégorie depuis Supabase
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch(`/api/products?category_slug=${categorySlug}&subcategory_slug=${subcategorySlug}`);
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#2C1A0E] mb-2">
            {products[0]?.category || 'Sous-catégorie'}
          </h1>
