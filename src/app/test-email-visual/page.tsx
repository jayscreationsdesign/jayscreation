...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" 
  ...
  <tr>
    <td align="center">
      <table role="presentation" width="600" cellpadding="0" cellspacing="0"
        ...
        <!-- HEADER -->
        <tr>
          <td align="center" style="background:#FFF8F0; text-align:center; 
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" 
              ...
              <tr>
                <td width="148" height="148" 
                  ...
                  <img src="https://www.jayscreationsdesign.fr/images/logo/logo_transparent.png"
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="padding-bottom:12px;">
                              <div style="font-family:'Inter',Arial,sans-serif; font-size:13px; 
                                          color:#aaa; margin-bottom:4px; font-weight:500;">Commande n°</div>
                              <div style="font-family:'Inter',Arial,sans-serif; font-size:15px; 
                                          color:#2C1A0E; font-weight:600;">#CMD-TEST-123</div>
                            </td>
                          </tr>
                          <tr>
                            <td style="padding-bottom:12px;">
                              ...
                              <div style="font-family:'Inter',Arial,sans-serif; font-size:15px; 
                                          color:#2C1A0E; font-weight:600;">14 avril 2026</div>
                            </td>
                          </tr>
                        </table>
                      </td>
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="padding-bottom:12px;">
                              ...
                              <div style="font-family:'Inter',Arial,sans-serif; font-size:15px; 
                                          color:#2C1A0E; font-weight:600;">Anais Test</div>
                            </td>
                          </tr>
                          <tr>
                            <td style="padding-bottom:12px;">
                              ...
                              <div style="font-family:'Inter',Arial,sans-serif; font-size:18px; 
                                          color:#8B4513; font-weight:600;">15.99</div>
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                      <td style="padding:12px; background:#ffffff; border-left:4px solid #8B4513; border-radius:0 8px 8px 0;">
                        ...
                        <div style="font-family:'Inter',Arial,sans-serif; font-size:13px; 
                                    color:#aaa; margin-bottom:2px;">Thème: Test Logo</div>
                        <div style="font-family:'Inter',Arial,sans-serif; font-size:13px; color:#aaa;">
                          Quantité: 1 × 15.99 = 15.99
                        </div>
                      </td>
                    </tr>
                  </table>
              ...
              <tr>
                <td style="text-align:center; padding:24px;">
                  ...
                  <div style="font-family:'Inter',Arial,sans-serif; 
                    ...
                    Nous traitons votre commande avec soin<br>
                    Vous recevrez bientôt une confirmation de livraison
                  </div>
                </td>
              </tr>
            </table>
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      <h1>Aperçu Visuel - Email de Confirmation de Commande</h1>
      <p>Ceci est un aperçu de l'email tel qu'il apparaîtra dans un client email.</p>
      
      <div style={{ border: '1px solid #ddd', borderRadius: '8px', overflow: 'hidden', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ marginTop: '20px', padding: '15px', backgroundColor: '#f5f5f5', borderRadius: '8px' }}>
        ...
        <ul>
          <li>Logo visible dans le rond en haut avec fond marron</li>
          <li>Police "Jay's Creations Design" en Great Vibes dans le header</li>
          <li>Police "Jay's Creations Design" en Great Vibes dans le footer</li>
          <li>Couleurs cohérentes avec l'identité de marque</li>
          <li>Structure responsive et lisible</li>
        </ul>
      </div>
    </div>
  );
