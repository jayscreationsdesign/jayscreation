// Script de test pour l'email de confirmation de commande avec identifiants
// ATTENTION: Contient les identifiants SMTP - à utiliser uniquement pour les tests
...
const SMTP_CONFIG = {
  ...
  pass: 'Anais2025!', // Mot de passe configuré
  host: 'smtp.ionos.fr',
  port: 465,
  secure: true
};
...
async function testOrderConfirmation() {
  ...
  console.log('- Hôte:', SMTP_CONFIG.host);
  ...
  if (SMTP_CONFIG.pass === 'votre-mot-de-passe-ici') {
    console.log('ATTENTION: Veuillez configurer les identifiants SMTP dans le script avant de continuer.');
    console.log('Modifiez la variable SMTP_CONFIG.pass avec votre vrai mot de passe Ionos.');
    return;
  }
  ...
  try {
    ...
    if (result.success) {
      ...
      console.log('');
      console.log('Les nouveaux templates avec la charte graphique unifiée ont été utilisés:');
